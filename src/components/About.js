...
const About = () => {
  return (
    <div className='py-4 mt-4 about px-4 rounded-xl'>
      <div className='about-top py-4 '>
        <h3 className='text-[#FF6913] mb-4'>About Us</h3>
        <h4 className='text-3xl text-white font-bold mb-6'>WHY CHOOSE US.</h4>
        <p className='text'>Because Terke will make it easier for you to send your package with the features we have</p>
      </div>

      <div className='about-bottom py-4 flex flex-col'>
        <div className='py-4 px-3 rounded-xl bg-[#FF6913] mb-5'>
        ...
        <div className='py-4 px-3 rounded-xl about-bg mb-5'>
